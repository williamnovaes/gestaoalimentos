...
@Entity
@Table(name = "autenticacao_log", schema = "gestao")
public class AutenticacaoLog implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name = "autenticacaoLogSeq", sequenceName = "autenticacao_log_id_seq", allocationSize = 1, schema = "gestao")

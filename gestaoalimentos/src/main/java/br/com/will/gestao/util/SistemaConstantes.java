...
public final class SistemaConstantes {
	...
	public static final String E_STATUS_DEFAULT_PENDENTE = "varchar(10) default 'PENDENTE'";
	public static final String E_STATUS_DEFAULT_ENVIADO = "varchar(10) default 'ENVIADO'";
	
	public static final String E_ENTREGA_DEFAULT_ENTREGAR = "varchar(10) default 'ENTREGAR'";
	
	public static final String E_PAGAMENTO_DEFAULT_DINHEIRO = "varchar(10) default 'DINHEIRO'";
	public static final String E_PAGINA_TIPO_DEFAULT_LISTAGEM = "varchar(10) default 'LISTAGEM'";
	...
	public static final String E_FORMA_PAGAMENTO = "varchar(10) default 'À_VISTA'";
	...
	public static final String DIRETORIO_SISTEMA = "/opt/gestao/";

	public static final String DIRETORIO_TMP = "/tmp/";

	public static final String DIRETORIO_ARQUIVOS = DIRETORIO_SISTEMA + "arquivos/";

	public static final String DIRETORIO_VENDAS = DIRETORIO_SISTEMA + "vendas/";
	...
	public static final String DIR_IMAGENS = "/br/com/will/gestao/images/";

	public static final String BR_COM_WILL_GESTAO_REPORTS = "/br/com/will/gestao/reports/";
	...
	// está em bytes ->  Conversão  para mega = 10mb
	public static final int TAMANHO_MAXIMO_IMAGEM_CHAMADO_MOTIVO = 2097152; 
	// está em bytes -> Conversão para mega = 2mb

	public static final String NOME_CLIENTE = "\\[NOME DO CLIENTE\\]";
	public static final Integer DIGITOS_CODIGO_BARRA = SistemaConstantes.NOVE;

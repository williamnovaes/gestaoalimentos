...
@Entity
@Table(name = "arquivo_tipo", schema = "gestao")
public class ArquivoTipo implements SituacaoAlteravel, Descritivel,
	...
	@Id
	@SequenceGenerator(name = "arquivoTipoSeq", sequenceName = "arquivo_tipo_id_multi_seq", allocationSize = 1, schema = "gestao")
	...
	@Column(name = "codigo", length = SistemaConstantes.DESCRICAO)
